              ...
              return (
                ...
                >
                  ...
                  <td className="px-5 py-4 text-right text-green-600 font-medium whitespace-nowrap">
                    {entry.lostKg > 0 ? "-" : ""}{Math.abs(entry.lostKg).toFixed(1)}
                  </td>
                  <td className="px-5 py-4 text-right text-green-600 font-bold whitespace-nowrap">
                    {entry.lostPercent > 0 ? "-" : ""}{Math.abs(entry.lostPercent).toFixed(1)}%
                  </td>
                </tr>
              )
            })}
...
function LeaderboardSection({
  ...
  const activeData = monthTab === "current" ? currentData : monthTab === "prev" ? prevData : historyData
