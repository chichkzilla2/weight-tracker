...
const adminSections = [
  {
    ...
    steps: [
      ...
      "กดปุ่ม รายละเอียด เพื่อดูข้อมูลผู้ใช้ เช่น user_id, role, ชื่อจริง, นามสกุล และกลุ่ม",
      "ในหน้ารายละเอียด สามารถแก้ไขชื่อจริง นามสกุล และเปลี่ยนกลุ่มของผู้ใช้ได้",
      "ถ้าต้องการเปลี่ยนรหัสผ่าน ให้กด แก้รหัสผ่าน แล้วกรอกรหัสผ่านใหม่",
