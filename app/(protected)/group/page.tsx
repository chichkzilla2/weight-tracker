...
export default async function GroupPage() {
  ...
  const memberStats = members
    .map((m) => {
      ...
      const firstWeight = wEntries[0]
        ? parseFloat(wEntries[0].weight.toString())
        : null;
      ...
      const firstWaist = waEntries[0]
        ? parseFloat(waEntries[0].waist.toString())
        : null;
    ...
    .sort((a, b) => {
      ...
      if (a.lastWeight === null && b.lastWeight !== null) return 1;
      if (a.weightChange !== null && b.weightChange !== null)
  ...
  function ChangeCell({
    ...
    if (change === null || count <= 1)
      return <span className="text-xs text-[#343A46]">—</span>;
    return (
      <span
    ...
    <div className="max-w-lg mx-auto">
      ...
      <div className="px-4 pb-6 space-y-4">
        ...
        <div className="glass-card rounded-2xl p-4">
          ...
          <div className="w-full bg-[#242832]/65 rounded-full h-2">
            <div
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-[#000000] border-b border-white/10">
                  ...
                  <th className="text-right px-3 py-2.5 font-semibold text-[#A8AFBD] whitespace-nowrap">
                    น้ำหนักล่าสุด
                  </th>
                  <th className="text-right px-3 py-2.5 font-semibold text-[#A8AFBD] whitespace-nowrap">
                    น้ำหนักเปลี่ยน
                      ...
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          <p className="text-sm font-medium text-[#E7EAF0] whitespace-nowrap">
                            {m.realName}
                            {m.isMe && (
                              <span className="text-[10px] text-[#A8AFBD] ml-1 font-normal">
                                (คุณ)
                              </span>
                            )}
                          </p>
                    ...
                    <td className="px-3 py-3 text-right whitespace-nowrap">
                      {m.lastWeight !== null ? (
                        <span className="text-sm font-bold text-[#F59E0B]">
                          ...
                          <span className="text-xs font-normal text-[#A8AFBD]">
                            {" "}
                            กก.
                          </span>
                        </span>
